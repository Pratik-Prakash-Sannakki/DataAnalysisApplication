...
class PlotCanvas(FigureCanvas):
    ...
    def __init__(self, parent=None, width=100, height=100, dpi=100):
        ...
        self.axes = fig.add_subplot(223)
        self.axes = fig.add_subplot(224)
    ...
    def plot(self):
        ...
        ax.set_xlabel("Time ")
        ax.set_ylabel(tix.myparam[1])
        ax.plot(tix.vol, 'ro--')
        self.draw()
    def plot1(self):
        ax1 = self.figure.add_subplot(223)
        ax1.set_xlabel("Time ")
        ax1.set_ylabel(tix.myparam[2])
        ax1.plot(tix.cur,'go--')
        self.draw()
    def plot2(self):
        ax2 = self.figure.add_subplot(224)
        ax2.set_xlabel("Time ")
        ax2.set_ylabel(tix.myparam[3])
        ax2.plot(tix.temp,'bo--')
        self.draw()
